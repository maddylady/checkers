          ...
          >
            <div className="max-w-6xl mx-auto px-4 py-4">
              ...
              <div className={`grid gap-5 items-start ${selectorStep === 'mode' ? 'lg:grid-cols-5' : 'lg:grid-cols-1'}`}>
                ...
                >
                  <div className={`rounded-3xl p-4 border bg-white border-gray-200 dark:bg-gray-900/80 dark:border-white/10 backdrop-blur-sm shadow-lg ${selectorStep !== 'mode' ? 'max-w-2xl mx-auto w-full' : ''}`}>
                    <ModeSelector
                      key={selectorKey}
